...
import com.zsgs.Nalam.view.SignUpView;
class SignUpModel{
    ...
    Employee.Role parseRole(String choice) {
        ...
        if (c.equals("1") || c.equalsIgnoreCase("Accountant")) return Employee.Role.ACCOUNTANT;
        if (c.equals("2") || c.equalsIgnoreCase("Pharmacist")) return Employee.Role.PHARMACIST;
        return null;
    }
